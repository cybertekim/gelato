	...
	jQuery.fn.awShowcase = function(options) {
		...
		if (options.thumbnails)
		{
			...
			if (options.thumbnails_position === 'outside-first' || options.thumbnails_position === 'outside-last')
			{
				...
				{
					/* outside & horizontal */
					jQuery(thumb_wrapper).find('.showcase-thumbnail').css('float', 'none');
					jQuery(thumb_wrapper).find('.showcase-thumbnail').css('display', 'inline');
			...
			thumb_restriction.css({'overflow' : 'hidden', 'position' : 'relative', 'align' : 'center'});
			if (options.thumbnails_direction === 'horizontal') { thumb_restriction.css({'float' : 'none'}); }
			
			// Add class and style to thumbnail wrapper 
			thumb_wrapper.addClass('showcase-thumbnail-wrapper');
			
			if (options.thumbnails_direction === 'horizontal') { thumb_wrapper.addClass('showcase-thumbnail-wrapper-horizontal');
			//thumb_wrapper.css('width':'630px');
			}
